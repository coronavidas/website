              ...
              <div class="service-item service-item1">
                  <div class="service-item-inner">
                      <div class="service-content">
                        ...
                        <a target="_blank" href="http://vaka.me/959699" class="theme-btn" >Doar para a cidade de Jequié</a>                      </div>
                  </div><!-- end service-item-inner -->
              </div><!-- end service-item -->
          </div><!-- end col -->
          <div class="col">
                  ...
                  <div class="service-item-inner">
                      <div class="service-content">
                       ...
                       Faça parte do movimento e ajude as pessoas da cidade de Marília-SP
                        ...
                        <a target="_blank" href="http://vaka.me/966668" class="theme-btn" >Doar para a cidade de Marília.</a>                      </div>
                  </div><!-- end service-item-inner -->
              </div><!-- end service-item -->
          </div><!-- end col -->
      </div><!-- end row -->
...
<a target="_blank" href="http://vaka.me/968449" class="theme-btn" >Doar para a cidade de Bauru.</a>                      </div>
                  </div><!-- end service-item-inner -->
              </div><!-- end service-item -->
          </div><!-- end col -->
          <div class="col">
...
<!-- <a target="_blank" href="https://chat.whatsapp.com/DcL189qM2WIHr8K0X1THmf" class="theme-btn" >Faça parte</a> -->                      </div>
                  </div><!-- end service-item-inner -->
              </div><!-- end service-item -->
          </div><!-- end col -->
          <div class="col">
...
<a target="_blank" href="https://chat.whatsapp.com/JGlX3K0gr7WDKa7dZuCMvO" class="theme-btn" >Faça parte</a>                      </div>
                  </div><!-- end service-item-inner -->
              </div><!-- end service-item -->
          </div><!-- end col -->
      </div>
